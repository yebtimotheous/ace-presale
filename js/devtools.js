...
// // Check if the request is made by a web scraper or bot
// function isWebScraper(userAgent) {
//   const webScraperAgents = [
//     "wget",
//     "curl",
//     "python-requests",
//     "httpie",
...
//   for (const agent of webScraperAgents) {
...
// // Check if the request is made by a web scraper or bot
// if (isWebScraper(userAgent)) {
//   // Redirect or show an error message if the request is made by a web scraper
//   window.location.href = "https://google.com"; // Replace with your desired error page or action
// }
